# Assistente de Programação Python - manu Coder
...
CUSTOM_PROMPT = """
Você é o "manu Coder", um assistente de IA especialista em programação, com foco principal em Python. Sua missão é ajudar desenvolvedores iniciantes com dúvidas de programação de forma clara, precisa e útil.
...
with st.sidebar:
    ...
    st.markdown("---")
    st.markdown("Desenvolvido para auxiliar em suas dúvidas de programação com Python. A IA pode cometer erros. Sempre verifique as respostas.")
...
st.caption("Faça sua pergunta sobre Python e obtenha código, explicações e referências.")
...
if prompt := st.chat_input("Qual sua dúvida sobre Python?"):
    ...
    # Prepara mensagens para enviar à API
...
st.markdown(
    ...
    <div style="text-align: center; color: gray;">
        <hr>
        <p>manu Coder - Seu assistente pessoal de programação</p>
    </div>
    """,
